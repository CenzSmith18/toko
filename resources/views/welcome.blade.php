				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           ...
                           <a class="nav-item nav-link last" href="contact.html"><img src="{{asset('images/shop_icon.png')}}"></a>
                        </div>
                    </div>
                    </nav>
				</div>
	    ...
	    <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
					...
					<div class="col-sm-5">
						<div class="shoes_img"><img src="{{asset('images/running-shoes.png')}}"></div>
					</div>
				</div>
                </div>
    	    	...
    	    	<div class="row">
    	    		<div class="col-md-6">
    	    			<div class="about-img">
    	    				...
    	    				<div class="shoes-img"><img src="{{asset('images/shoes-img1.png')}}"></div>
    	    		...
    	    		<div class="col-md-6">
    	    			<div class="about-img2">
    	    				<div class="shoes-img2"><img src="{{asset('images/shoes-img2.png')}}"></div>
    	    				<p class="sport_text">Men Sports</p>
    	    				<div class="dolar_text">$<strong style="color: #f12a47;">90</strong> </div>
    	    				<div class="star_icon">
    	    					<ul>
        ...
        @foreach($produk as $p)
            <div class="col-sm-4">
              <div class="best_shoes">
                ...
                <div class="shoes_icon"><img src="{{asset('images/shoes-img4.png')}}"></div>
                <div class="star_text">
                  <div class="left_part">
                    <ul>
                  ...
                  <div class="right_part">
                    <div class="shoes_price">Rp.<span style="color: #ff4e5b;">{{$p->harga}}</span></div>
                  </div>
                </div>
              </div>
            </div>
    	...
    	<div class="container">
    		<div class="mail_section">
    			<div class="row">
    				...
    				<div class="col-sm-6 col-lg-2">
    					<div class="footer-logo"><img src="{{asset('images/phone-icon.')}}"ng"><span class="map_text">(71) 1234567890</span></div>
    				</div>
    				<div class="col-sm-6 col-lg-3">
    					<div class="footer-logo"><img src="{{asset('images/email-icon.')}}"ng"><span class="map_text">Demo@gmail.com</span></div>
    				</div>
    				<div class="col-sm-6 col-lg-3">
    					<div class="social_icon">
    						<ul>
    							<li><a href="#"><img src="{{asset('images/fb-icon.png')}}"></a></li>
    							<li><a href="#"><img src="{{asset('images/twitter-ico')}}".png"></a></li>
    	    ...
    	    <div class="footer_section_2">
		        <div class="row">
    		        ...
    		        <div class="col-sm-4 col-lg-2">
    		        	...
    		        	<div class="image-icon"><img src="{{asset('images/map-icon.pn')}}""><span class="pet_text">No 40 Baria Sreet 15/2 NewYork City, NY, United States.</span></div>
    		        </div>
